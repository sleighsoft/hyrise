...
CreateViewNode::CreateViewNode(const std::string& view_name, std::shared_ptr<const AbstractLQPNode> lqp) : AbstractLQPNode(LQPNodeType::CreateView), _view_name(view_name), _lqp(lqp) {}
